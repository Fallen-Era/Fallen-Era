...
bool FPCGWaitForVoxelWorldElement::PrepareDataInternal(FPCGContext* Context) const
{
	...
	// Forward the input collection as-is (keeping DataCrcs), only overriding the pin:
	// in 5.8 DataCrcs is no longer a parallel array to TaggedData at PrepareData time
